    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="col-md-8 offset-lg-3 offset-sm-2">
                        <div class="d-flex flex-column flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
                            <h1 class="m-4 text-center">Star Wars Movies</h1>

                            <div class="movie-section d-flex flex-column ">
                                <img src="startwars.jpg" class="movieImg img-responsive">
                            </div>
                            <br>
                            <div class="row">
        ...
        <script src="https://unpkg.com/mustache@latest"></script>
            ...
            <div class="imageContainer" data-id="{{id}}">
                <img src="{{url}}{{poster_path}}" onerror="this.onerror=null;this.src='altImage.jpg';" data-movie-id="{{id}}"/>
                </div>
            {{/movies}}
            </section>
