            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8 offset-lg-3 offset-sm-2">
                        ...
                        <div class="row min-content-height parent-guide">
                            <div class="col-md-4 col-md-offset-1">
                                <img src="parentguide.png" class="center-block img-responsive">
                            </div>
                            <div class="col-md-4 col-md-offset-3">
                                <p class="paragraph">Use Movie Time Family Library. It has all movies that are appropriate for all kids ages. The parents also have the option to pick only family movies so it won't allow the user to watch any other movie except this category.</p>
                            </div>
                        </div>
                        <br>
                        <br>
